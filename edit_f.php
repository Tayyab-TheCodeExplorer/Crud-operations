                            ...
                            <div class="card-body">
                                <div class="m-sm-4">
                                    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="img_path" value="<?php echo $result['image']?>">
                                        <div class="mb-3">
                                            <label class="form-label">Name</label>
                                            <input placeholder="Enter your name" name="name" type="text" class="form-control form-control-lg" value="<?php echo $result['name']?>">
                                            <p name="nameerror"><?php echo $nameerror ?></p>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Email</label>
                                            <input class="form-control form-control-lg" type="email" name="email" placeholder="Enter your email" value="<?php echo $result['email']?>">
                                            <p name="emailerror"><?php echo $emailerror ?></p>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Password</label>
                                            <input class="form-control form-control-lg" type="password" name="pass" placeholder="Enter password" value="<?php echo $result['password']?>">
